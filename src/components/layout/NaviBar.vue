  ...
  <v-container>
    <v-toolbar app flat height="50">
      ...
      <router-link :to="{ name: 'user' }" class="link">
        <v-btn v-show="isLogin" class="font-weight-bold" text>Login</v-btn>
        <v-btn v-show="!isLogin" class="font-weight-bold" text>UserInfo</v-btn>
      </router-link>
    </v-toolbar>
  </v-container>
</template>
